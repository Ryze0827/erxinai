const landingMessages = {
  en: {
    "document.title": "WayX — One gateway for every model",
    "nav.home": "WayX home",
    ...
    "pricing.kicker": "Choose a billing method",
    "pricing.group": "Billing method",
    "pricing.usage": "Usage based",
    "pricing.subscription": "Subscription",
    "pricing.price.usage": "Usage",
    "pricing.price.subscription": "Coming soon",
    ...
    "pricing.note.subscription": "Subscriptions are not available yet.",
    "pricing.action.guest": "Create an account",
    "pricing.action.authenticated": "Start using",
    "pricing.action.unavailable": "Coming soon",
    ...
    "faq.what.question": "What is WayX?",
    ...
    "faq.start.answer": "Create a WayX account, generate a project key, update your client base URL, and send your first request using a supported model identifier.",
    "footer.note": "Build against one stable AI interface while WayX keeps provider access, routing, and usage visible.",
    "footer.product": "Product",
    "footer.account": "Account",
    "footer.tagline": "AI gateway for developers",
    "demo.gateway": "WayX Gateway",
    "demo.live": "Live",
    "demo.model": "Model",
  ...
  zh: {
    "document.title": "WayX — 一个网关，连接所有模型",
    "nav.home": "WayX 首页",
    "nav.primary": "主导航",
    "nav.features": "功能",
    "nav.pricing": "价格",
    ...
    "faq.start.answer": "注册 WayX 账号，创建项目密钥，更新客户端基础地址，然后使用受支持的模型标识发送第一个请求。",
    "footer.note": "只需对接一个稳定的 AI 接口，WayX 会让服务商接入、请求路由和用量始终清晰可见。",
    "footer.product": "产品",
    "footer.account": "账号",
    "footer.tagline": "为开发者打造的 AI 网关",
    "demo.gateway": "WayX 网关",
    "demo.live": "实时",
    "demo.model": "模型",
...
export function syncPriceAmount(root) {
