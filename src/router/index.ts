...
const cdkRechargeViewLoader: RouteComponentLoader = () => import('../views/CdkRecharge.vue')
const batchQueryViewLoader: RouteComponentLoader = () => import('../views/BatchQuery.vue')
...
const routeWarmupLoaders: RouteComponentLoader[] = [
    ...
    noticeViewLoader,
    loginViewLoader,
    cdkRechargeViewLoader,
    batchQueryViewLoader,
]
...
const router = createRouter({
    ...
    routes: [
        ...
        },
        {
            path: '/cdk-recharge',
            name: 'cdk-recharge',
            component: cdkRechargeViewLoader,
        },
        {
            path: '/batch-query',
            name: 'batch-query',
            component: batchQueryViewLoader,
        },
        {
            path: '/:pathMatch(.*)*',
            name: 'not-found',
