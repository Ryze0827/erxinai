...
export function AffiliatePage() {
  ...
  return <Page title={t("affiliate.title")} actions={<Button variant="primary" icon="dollar" onClick={transfer} disabled={state.busy || detail.aff_quota <= 0}>{state.busy ? t("common.loading") : t("affiliate.transfer")}</Button>}>
