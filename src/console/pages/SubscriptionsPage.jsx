...
export function SubscriptionsPage() {
  ...
  return <Page title={t("subscriptions.title")} actions={settings?.payment_enabled !== false && <Button variant="primary" icon="cart" onClick={() => { window.location.href = "/purchase"; }}>{t("subscriptions.renew")}</Button>}>
