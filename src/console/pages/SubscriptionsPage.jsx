...
function QuotaCell({ progress, fallback, formatCurrency, locale }) {
  ...
  const tone = percentage >= 90 ? "danger" : percentage >= 60 ? "warning" : "success";
